...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(self.ventana, state="disabled", width=40, height=3, background="orchid", foreground="black", font=("Gravity Font",15))
    ...
    def crearBoton(self, valor, escribir=True, ancho=9, alto=1):
        return Button(self.ventana, text=valor, width=ancho, height=alto, font=("Gravity Font",15), command=lambda:self.click(valor,escribir))
